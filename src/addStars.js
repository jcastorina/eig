export default class addStars{
    constructor(){
        ...
        for ( let i = 0; i < 300; i ++ ) {
            ...
            this.vertices.push( THREE.MathUtils.randFloatSpread( spread ) ); // x
            this.vertices.push( THREE.MathUtils.randFloatSpread( spread ) ); // y
            this.vertices.push( THREE.MathUtils.randFloatSpread( spread ) ); // z
        ...
        for ( let i = 0; i < 3000; i ++ ) {
            ...
            this.vertices1.push( THREE.MathUtils.randFloatSpread( spread ) ); // x
            this.vertices1.push( THREE.MathUtils.randFloatSpread( spread ) ); // y
            this.vertices1.push( THREE.MathUtils.randFloatSpread( spread ) ); // z
        ...
        for ( let i = 0; i < 300; i ++ ) {
            ...
            this.vertices2.push( THREE.MathUtils.randFloatSpread( spread ) ); // x
            this.vertices2.push( THREE.MathUtils.randFloatSpread( spread ) ); // y
            this.vertices2.push( THREE.MathUtils.randFloatSpread( spread ) ); // z
        ...
        for ( let i = 0; i < 100; i ++ ) {
            ...
            this.vertices3.push( THREE.MathUtils.randFloatSpread( spread ) ); // x
            this.vertices3.push( THREE.MathUtils.randFloatSpread( spread ) ); // y
            this.vertices3.push( THREE.MathUtils.randFloatSpread( spread ) ); // z
       ...
       // }
        ...
        this.particles[1].position.y = 20
        this.particles[4].position.y = 20
    ...
    starWhite(){
        ...
        if(this.particles[0].position.y < -20){
    ...
    starBlue(){//starBlueo Weematsu
        ...
        if(this.particles[3].position.y < -20){
        ...
        //if(this.particles[3].position.y < -200){
        //    this.particles[3].position.y = 0;
        //    this.particles[4].position.y = 200;
